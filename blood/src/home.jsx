  ...
  return (
    <div className="h-fit  bg-whitex">
      ...
      <div className="p-6 overflow-scroll h-4/6">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">TOP DONATER</h2>
          <div className="space-y-2">
            {showList.length === 0 ? (
              ...
              showList.map((user, idx) => (
                <div
                  key={idx}
                  className={` h-40 border  ${selectedUser?.uid === user.uid ? "bg-gray-300" : "bg-white"
                    }`}
      ...
      <div className="bg-black w-full h-20 text-center text-white py-10">
